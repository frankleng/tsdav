...
var getLogger__default = /*#__PURE__*/_interopDefaultLegacy(getLogger);
...
const debug$5 = getLogger__default["default"]('tsdav:request');
const davRequest = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const xmlBody = convertIncoming
        ? convert__default["default"].js2xml(Object.assign(Object.assign({ _declaration: { _attributes: { version: '1.0', encoding: 'utf-8' } } }, body), { _attributes: attributes }), {
            compact: true,
            spaces: 2,
            elementNameFn: (name) => {
    ...
    const result = convert__default["default"].xml2js(resText, {
        compact: true,
        trim: true,
...
const debug$3 = getLogger__default["default"]('tsdav:addressBook');
...
const debug$2 = getLogger__default["default"]('tsdav:calendar');
...
const debug = getLogger__default["default"]('tsdav:authHelper');
/**
